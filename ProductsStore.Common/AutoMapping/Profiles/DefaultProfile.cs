using AutoMapper;
using ProductsStore.Common.AutoMapping.Interfaces;
using System;
using System.Linq;

namespace ProductsStore.Common.AutoMapping.Profiles
{
    public class DefaultProfile : Profile
    {
        ...
        private void ConfigureMapping()
        {
            var allTypes = AppDomain
                .CurrentDomain
                .GetAssemblies()
                .Where(a => a.GetName().FullName.Contains(nameof(ProductsStore)))
